...
const LostPetForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (token) {
      ...
      console.log('Usuario anónimo, no se encontró token.');
    }
          ...
          <div className="row">
            <div className="col-md-7">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div className="form-group">
                    <label htmlFor="lostOrFoundDate">Fecha de Pérdida</label>
                    <input type="date" className={`form-control ${formData.lostOrFoundDate ? 'filled' : ''}`} id="lostOrFoundDate" name="lostOrFoundDate" value={formData.lostOrFoundDate} onChange={handleChange} />
                  </div>
            ...
            <div className="col-md-5">
              ...
              <div className="form-group">
                ...
                <input type="text" className={`form-control ${formData.reward ? 'filled' : ''}`} id="reward" name="reward" placeholder="Ej: $100" value={formData.reward} onChange={handleChange} />
              </div>
              <div className="form-group">

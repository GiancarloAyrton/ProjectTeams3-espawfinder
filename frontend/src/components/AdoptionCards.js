...
const AdoptionGallery = () => {
  ...
  useEffect(() => {
    const fetchAdoptionPosts = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/upload/adoption?limit=4`);
    ...
    <section id="adoption-home3" className="custom-section-adoption container-fluid pl-0 pr-0">
      <div className="adoption-gallery-container">
            ...
            return (
              <div className="card" key={post._id}>
                ...
                <div className="card-body">
                  ...
                  <div className="likes">
                    <i className="fas fa-heart"></i> {Math.floor(Math.random() * 100)}{' '}
                    {/* Random likes */}
                  </div>
                </div>
              </div>
        ...
        <div className="form-flex">
          <a href="/posts" className="btn btn-publicar btn-primary">
            Ver mas
          </a>
        </div>
      </div>

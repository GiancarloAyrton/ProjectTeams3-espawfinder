...
const LookingForMateForm = () => {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // Controla el estado del envío
  const [isPublished, setIsPublished] = useState(false); // Controla el feedback de publicación exitosa
...
export default LookingForMateForm;
...
if($id == '' || $token == ''){
   ...
   if($token == $token_tmp){
      ...
      $query = "SELECT * FROM mascotas_perdidas WHERE id=$id";
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                           ...
                           <div class="dropdown-menu pattern2" aria-labelledby="adopt-dropdown">
                              ...
                              <a class="dropdown-item active" href="adoption-single.html">Adoption Single Page</a>
               ...
               <div class="row">
                  <div class="adopt-card col-lg-12">
                     ...
                     <div class="col-md-4 float-left">
                        <img src="<?php echo $row['imagen']; ?>" class="img-fluid rounded" alt="">
                     </div>
                     <!-- Name -->
                     <div class="caption-adoption col-md-8 float-right res-margin">
                        ...
                        <ul class="list-unstyled mt-3">
                           <li><strong>Género:</strong> <?php echo $row['genero'] ?></li>
                           <li><strong>Raza:</strong> <?php echo $row['raza'] ?></li>
                           <li><strong>Color:</strong> <?php echo $row['color'] ?></li>
                           <li><strong>Fecha de pérdida:</strong> <?php echo $row['fecha_perdida'] ?></li>

...
<html lang="en">
   ...
   <body id="top">
      ...
      <!-- /nav -->
      <!-- ==== Header ==== -->
      <div id="header3" class="container-fluid overlay fixed-header">
         <div class="container">
            <!-- col-lg -->  
            <div class="col-lg-5 text-light" data-aos="fade-up">
               <h1>Bienvenido a Espaw Finder</h1>
               <p class="h7">Si perdiste o encontraste a una mascota ¡puedes publicarlo aqui!</p>
               <!-- button -->
               <a href="busqueda.php" class="btn btn-primary" >Publicar</a>
            </div>
            <!-- /col-lg -->  
         </div>
         <!-- /container -->		
            ...
            <div class="col-lg-4">
               <div class="serviceBox1 bg-tertiary pattern3">
                  <div class="service-content bg-light">
                     ...
                     <!-- title -->
                     <h3 class="title"><a href="services-single.html">Veterinaria</a></h3>
                     <!-- /description -->
                     <p class="description">
                  ...
                  <div class="text-center">
                     <a class="btn btn-primary" href="services-single.html">Leer Más</a>
                  </div>
               </div>
               <!-- /serviceBox-->
            </div>
            ...
            <div class="col-lg-4">
               <div class="serviceBox1 bg-tertiary pattern3">
                  <div class="service-content bg-light">
                     ...
                     <!-- title -->
                     <h3 class="title"><a href="services-single.html">Peluquería</a></h3>
                     <!-- /description -->
                     <p class="description">
                        Qui quaerat fugit quas veniam perferendis repudiandae sequi, dolore quisquam illum.
                     </p>
            ...
            <div class="col-lg-4">
               <div class="serviceBox1 bg-tertiary pattern3">
                  <div class="service-content bg-light">
                     ...
                     <!-- title -->
                     <h3 class="title"><a href="services-single.html">Adopción</a></h3>
                     <!-- /description -->
                     <p class="description">
                        Qui quaerat fugit quas veniam perferendis repudiandae sequi, dolore quisquam illum.
                     </p>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-6">
                  ...
                  <span class="h7 mt-0">Ofrecemos servicios rápidos y fáciles para perros y gatos, accumsan felis id, fermentum purus. Quisque vitae hendrerit elit. </span>
                  ...
                  <!-- Button -->	 
                  <a href="contact.html" class="btn btn-primary mt-3">Contactanos</a>
               </div>
               <!-- /col-lg-->
               <div class="col-lg-6">
                  <!-- services carousel -->
                  <div class="carousel-1item owl-carousel owl-theme container res-margin">
                     <img src="img/box1.jpg" class="img-fluid" alt=""/>
                     <img src="img/box2.jpg" class="img-fluid" alt=""/>
                     <img src="img/box3.jpg" class="img-fluid" alt=""/>
                  </div>
                  <!-- /owl-carousel -->
               </div>
               <!-- /col-lg-->
      ...
      <!-- /section ends -->
	  <!-- section -->
      <section id="testimonials-section" class="container-fluid overlay-dark">
         <div class="container">
         <!-- row -->
         <div class="row">
            <div class="col-lg-10 offset-lg-1">
               ...
               <div class="mt-5">
                  <!-- testimonials -->
                  <div class="carousel-1item text-light owl-carousel owl-theme col-md-12">
                     <!-- testimonial -->
	 ...
	 <!-- /section ends -->
      ...
      <!-- section -->
      <section id="about-home3">
         <div class="container">
            <!-- section heading -->  
            <div class="section-heading text-center">
               <p class="subtitle">Conoce</p>
            ...
            <div class="row">
               <!-- Tabs -->
               <div class="col-md-8">
                  <h3>Tus mascotas se merecen lo mejor</h3>
                  <!--divider -->
               ...
               <div class="col-lg-4 res-margin">
                  <h4>Eventos de adopción</h4>
                  <!--divider -->
                  <hr class="small-divider left"/>
                  <!-- Button -->	 
                  <div class="carousel-1item owl-carousel owl-theme col-md-12">
                     <!-- event 1 -->		 
                     <div class="widget2">
            ...
            <div  class="row col-lg-10 offset-lg-1">
               ...
               <div class="col-xl-3 col-md-6">
                  <div class="counter">
                     ...
                     <h3 class="title">Mascotas adoptadas</h3>
                  </div>
                  <!-- /counter -->
               </div>
               <!-- /col-lg -->
      ...
      ?> 
       <section id="adoption-home3" class="container-fluid pl-0 pr-0">
         <!-- section heading -->  
         <div class="section-heading text-center">
         ...
         <div class="container">
            ...
            <div class="row mt-4">
               <?php
                  $query = "SELECT * FROM mascotas_perdidas ORDER BY id DESC";
                     ...
                     <div class="adopt-card res-margin row bg-light pattern2">
                        <div class="col-md-5">
                           ...
                           <div class="adopt-image d-flex flex-wrap align-items-center ">
                              <a href="adoption-single.php?id=<?php echo $row['id']; ?>&token=<?php echo
                           hash_hmac('sha1', $row['id'], KEY_TOKEN);?>">
                              <img src="<?php echo $row['imagen']; ?>" class="img-fluid" alt="Foto de la mascota perdida" style="max-width: 170px; max-height: 270px; object-fit: contain;">
                              </a>
                           </div>
                        </div>
                        <div class="col-md-7 res-margin">
                           ...
                           <div class="caption-adoption">
                              <h5 class="adoption-header"><a href="adoption-single.html"><?php echo $row['nombre']; ?></a></h5>
                              <!-- List -->
                              <ul class="list-unstyled">
                                 <li><strong>Genero:</strong><?php echo $row['genero']; ?></li>
                                 <li><strong>Especie:</strong><?php echo $row['especie']; ?></li>
                                 <li><strong>Raza:</strong><?php echo $row['raza']; ?></li>
                                 <li><strong>Color:</strong><?php echo $row['color']; ?></li>
                                 <li><strong>Mensaje:</strong><?php echo $row['message']; ?></li>
                                 <li><strong>Descripción:</strong><?php echo $row['descripcion']; ?></li>
                              </ul>
                           </div>
                        </div>
                        <div class="col-md-12 mt-3">
                           ...
                           <div class="text-center">
                              <!-- Adopt info -->
                              <ul class="col-md-12 adopt-card-info list-unstyled">
                                 <li ><i class="flaticon-veterinarian-hospital"></i>necesidades especiales</li>
                                 <li ><i class="flaticon-dog-4"></i>Amigable con otras mascotas</li>
                                 <li ><i class="flaticon-syringe"></i>Vacunado</li>
                                 <li ><i class="flaticon-dog-20"></i>Amigable con los niños</li>
                              </ul>
                              <!-- button-->
                              <a href="adoption-single.php?id=<?php echo $row['id']; ?>&token=<?php echo
                           hash_hmac('sha1', $row['id'], KEY_TOKEN);?>" class="btn btn-primary">Más información</a>
                           </div>
                           <!-- /text-center -->
                        </div>
                        <!-- /col-md -->
            ...
            <div class="col-lg-12 text-center mt-3">
               <!-- button --> 
               <a href="adoption.php" class="btn btn-secondary mt-3">Ver galería de adopción</a>
            </div>
            <!-- /col-lg -->
         </div>
         <!-- /container-->
      ...
      <!-- /section ends -->
      <!-- section --> 
      <section id="feature-section" class="bg-primary pattern1 text-light">
         <div class="container">
            <!-- section heading -->  
            <div class="section-heading text-center">
               <p class="subtitle">Beneficios para ti</p>
            ...
            <div class="row text-center">
               <!-- feature -->
               <div class="feature-with-icon feature2 col-lg-3">
                  <div class="icon-features">
                     <!-- icon -->
                     <i class="flaticon-pet-lotion"></i>
                  </div>
                  <h5><strong>Productos naturales</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
               <!-- feature -->
               <div class="feature-with-icon feature2 col-lg-3">
                  <div class="icon-features">
                     <!-- icon -->
                  ...
                  <h5><strong>Atención veterinaria</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
               <!-- feature -->
               <div class="feature-with-icon feature2 col-lg-3">
                  ...
                  <h5><strong>Capacitación</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
               <!-- feature -->
            ...
            <div class="row mt-3 text-center">
               ...
               <div class="feature-with-icon feature2 col-lg-3">
                  ...
                  <h5><strong>Cuidado de calidad</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
               <!-- feature -->
               <div class="feature-with-icon feature2 col-lg-3">
                  ...
                  <h5><strong>Actividades divertidas</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
               <!-- feature -->
               <div class="feature-with-icon feature2 col-lg-3">
                  <div class="icon-features">
                     <!-- icon -->
                     <i class="flaticon-animals-8"></i>
                  </div>
                  <h5><strong>Cuidado de gatos</strong></h5>
                  <p>Etiam rhoncus leo a dolor placerat, nec elem entum ipsum convall.</p>
               </div>
               <!-- /feature-with-icon feature2 col-lg-3-->
            </div>
      ...
      <section id="gallery-home" class="container-fluid pl-0 pr-0">
         <div class="container">
            <!-- section heading -->  
            <div class="section-heading text-center">
               <p class="subtitle">Tour de imagenes</p>
               <h2>Galería</h2>
            </div>
            <!-- /section-heading -->
         </div>
         <div id="gallery-isotope" class="mt-5 tz-gallery">
            ...
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery2.jpg">
                  <img class="img-fluid" src="img/gallery/gallery2.jpg" alt="">
                  <!-- title -->
                  <div class="title">
                     <p>Charlie the Kittie got adopted</p>
                  </div>
               </a>
            </div>
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery3.jpg">
                  <img class="img-fluid" src="img/gallery/gallery3.jpg" alt="">
                  <!-- title -->
                  <div class="title">
                     <p>Samantha training Jo</p>
                  </div>
               </a>
            </div>
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery4.jpg">
                  <img class="img-fluid" src="img/gallery/gallery4.jpg" alt="">
                  <!-- title -->
                  <div class="title">
                     <p>Cute guinea pigs</p>
                  </div>
               </a>
            </div>
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery5.jpg">
            ...
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery6.jpg">
                  <img class="img-fluid" src="img/gallery/gallery6.jpg" alt="">
                  <!-- title -->
                  <div class="title">
                     <p>Lilla is a beautiful bengal cat that needs a home!</p>
                  </div>
               </a>
            </div>
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery7.jpg">
                  <img class="img-fluid" src="img/gallery/gallery7.jpg" alt="">
                  <!-- title -->
                  <div class="title">
                     <p>Teaching dogs to stay by your side while on walks </p>
                  </div>
               </a>
            </div>
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery8.jpg">
            ...
            <!-- image -->
            <div class="isotope-item col-lg-4 col-md-6">
               <a class="baguette-lightbox" href="img/gallery/gallery9.jpg">
      ...
      <!-- /section ends-->
      <!-- section-->
      <section id="team-home" class="container-fluid bg-secondary">
         <!-- section heading -->  
         <div class="section-heading text-center text-light">
         ...
         <!-- /section-heading -->  
         <div class="container">
            <div class="carousel-3items owl-carousel owl-theme mt-0 pt-0">
               <!-- Team member 1 -->
               <div class="col-md-12">
                  <div class="team-style1">
                     ...
                     <div class="team-content">
                        ...
                        <span class="post">Veterinarian</span>
                     </div>
                     <!-- /team-content -->
                  </div>
                  <!-- /team-style1 -->
               ...
               <div class="col-md-12">
                  <div class="team-style1">
                     ...
                     <div class="team-content">
                        ...
                        <span class="post">Cat Specialist</span>
                     </div>
                     <!-- /team-content -->
                  </div>
                  <!-- /team-style1 -->
               ...
               <div class="col-md-12">
                  <div class="team-style1">
                     ...
                     <div class="team-content">
                        ...
                        <span class="post">Adoption manager</span>
                     </div>
                     <!-- /team-content -->
                  </div>
                  <!-- /team-style1 -->
               ...
               <div class="col-md-12">
                  <div class="team-style1">
                     ...
                     <div class="team-content">
                        ...
                        <span class="post">Vet Asssitant</span>
                     </div>
                     <!-- /team-content -->
                  </div>
                  <!-- /team-style1 -->
            ...
            <div class="col-md-12 mt-5 text-center">
               <a href="team.html" class="btn btn-tertiary mt-2">View all team</a>
            </div>
         </div>
		  <!-- /container-->
      </section>
      ...
      <section id="contact-home" class="container-fluid">
         ...
         <div class="container">
            <div class="row">
               ...
               <!-- /col-lg-->
               <div class="col-lg-5 offset-lg-1 res-margin">
                  <h4>Get in Touch</h4>

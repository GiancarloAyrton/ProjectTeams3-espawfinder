      ...
      <div class="page container">
        ...
        <input type="submit" value="Enviar">
         ...
         <ul class="nav nav-pills category-isotope center-nav mt-5">
            ...
            <li class="nav-item">
               <a class="nav-link" href="#" data-toggle="tab" data-filter=".perro">Solo Perros</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="#" data-toggle="tab" data-filter=".gato">Solo Gatos</a>
            </li>
         </ul>
         <!-- /ul -->
         <!-- Gallery -->
         ...
         <?php
               ...
               <div class="<?php echo $row['especie']?> col-lg-6">
               <div class="isotope-item">
                  <div class="adopt-card res-margin row bg-light pattern2">
                     <div class="col-md-5">
                        <!-- Image -->
                        <div class="adopt-image d-flex flex-wrap align-items-center ">
                           <a href="busqueda-single.php?id=<?php echo $row['id']; ?>&token=<?php echo
                           hash_hmac('sha1', $row['id'], KEY_TOKEN);?>">
                           <img src="<?php echo $row['imagen']; ?>" class="img-fluid" alt="Foto de la mascota perdida" style="max-width: 179px; max-height: 270px; object-fit: contain;">
                           </a>
                        </div>
                     </div>
                     <div class="col-md-7 res-margin">
                        ...
                        <h5 class="adoption-header"><a href="busqueda-single.php?id=<?php echo $row['id']; ?>&token=<?php echo
                           hash_hmac('sha1', $row['id'], KEY_TOKEN);?>"><?php echo $row['nombre']; ?></a></h5>
                           <!-- List -->
                           <ul class="list-unstyled">
                              ...
                              <li><strong>Mensaje: </strong><?php echo $row['mensaje']; ?></li>
